...
# %%
print(affinity_scaler.data_min_, affinity_scaler.data_max_)
# %%
SMI_MAX_SIZE= 254
...
config = {
    ...
    'lr': 1e-5,
    'epochs': 1000,
    'properties': sorted(['affinity','tpsas','qeds','sas','logps']),
}
...
for i, data in enumerate(train_loader):
    ...
    end_time = time.time()
    print("Time taken for batch {}: {:.2f} seconds | samples done : {}".format(i, end_time - start_time, len(target_smiles)), end='\n',flush = True)
